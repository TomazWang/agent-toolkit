...
**For each major task:**
```bash
/task-management:manage-tasks create "Task description" --priority <level> --project <name>
```
...
I'll create these tasks with the /task-management:manage-tasks command. Ready to proceed?
```
