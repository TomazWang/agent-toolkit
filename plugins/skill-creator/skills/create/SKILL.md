---
name: create
description: Interactive wizard for creating Claude Code skills with proper structure and frontmatter
...
- User invokes `/skill-creator:create <name>`
...
3. Validate with: /skill-creator:validate analyze-code
```
