...
description: |
  ...
  Note: In autonomous mode (/kb:start-knowledge-base), planning happens automatically.
---
...
**Note**: `/kb:start-knowledge-base` creates the plan automatically. Use this skill for manual control.
...
To start learning:
   /kb:start-knowledge-base              ← Autonomous (recommended)
   /kb:learn-kb-topic <topic>      ← Manual, one at a time
═══════════════════════════════════════════════════════════════
```
